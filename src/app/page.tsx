      ...
      <main className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {blogs.length === 0 ? (
              <div className="text-center py-20">
                ...
                <p className="text-gray-500 text-lg mb-6">Be the first to share your expertise with the community!</p>
                <a
                  href="/create"
        ...
        <section className="bg-gradient-to-r from-gray-900 to-blue-900 text-white py-20">
          <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-xl mb-8 text-blue-100 animate-slide-in">
