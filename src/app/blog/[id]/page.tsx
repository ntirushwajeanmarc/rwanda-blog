    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50">
        ...
        <article className="max-w-4xl mx-auto px-4 pb-12">
          {/* Hero section */}
          <div className="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden mb-8 animate-fade-in">
            {/* Category badge */}
          ...
          {/* Comments section */}
          <section className="bg-white rounded-2xl shadow-lg border border-gray-200 p-8 animate-slide-in">
            ...
            <div className="mt-8 space-y-6">
              {blog.comments.length === 0 ? (
                ...
                blog.comments.map((comment, index) => (
                  <div 
                    key={comment.id} 
                    className="bg-gray-50 rounded-xl p-6 animate-fade-in"
